...
public class CreateXrayProject_TestScenario5 {
	...
	private void ProjectName() throws Throwable {
		...
		createproject.DemoWait();
		ExtentReport.test.log(LogStatus.INFO, "Project Name: " + LoadProperties.config.getProperty("XrayProject_Name3"));
	...
	private void TestCase() throws Throwable {
		...
		createproject.Click(Locators.TestSetButton);
		
		createproject.story(LoadProperties.config.getProperty("testsetstory1"));
		ExtentReport.test.log(LogStatus.PASS, "Test Set Successfully Created");
	...
	private void logout() {
		...
		InvokeBrowser.driver.get("C:\\Users\\piyus\\eclipse-workspace\\sandbox\\Reports\\ExtentReportResults.html");
	}
